...
const CartDisplay = async () => {
  ...
  // render component ----------------------------------------------------------------------------------------
  return (
    <div className="collapse collapse-arrow w-full rounded-xl border-2 border-accent border-opacity-10 bg-neutral bg-opacity-5 p-5 laptop:w-7/12">
      <input type="checkbox" />
      {/* 1. Title */}
      <div className="collapse-title text-3xl font-bold tracking-wider">
        <h1>Your Cart</h1>
      </div>
      ...
      <div className="collapse-content">
        ...
        {cart?.items.length !== 0 && (
          <div className="flex flex-col items-end">
            ...
            <Link
              href={"/checkout"}
              className="btn btn-accent tablet:w-[200px]"
            >
              Checkout
            </Link>
          </div>
